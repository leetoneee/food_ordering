...
import com.example.foodordering.Activity.ItemsList.ItemsListActivity
...
fun CategorySection(categories: SnapshotStateList<CategoryModel>, showCategoryLoading: Boolean) {
    ...
    if (showCategoryLoading) {
        ...
        val rows =
            categories.chunked(3) // chunked(3) là một hàm mở rộng của List trong Kotlin, giúp chia danh sách thành các nhóm con có kích thước cố định.
